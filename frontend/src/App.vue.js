...
function __VLS_template() {
    ...
    if (__VLS_ctx.authStore.isAuthenticated) {
        ...
        // @ts-ignore
        [ElMenuItem, ElMenuItem,];
        const __VLS_51 = __VLS_asFunctionalComponent(__VLS_50, new __VLS_50({ index: ("logout"), }));
        const __VLS_52 = __VLS_51({ index: ("logout"), }, ...__VLS_functionalComponentArgsRest(__VLS_51));
        ({}({ index: ("logout"), }));
        // @ts-ignore
        [authStore,];
